...
# The fused op (impl/fake/registration) lives next to the other unified MLA
# KV-cache ops in vllm.model_executor.layers.attention.mla_attention, so the
# manual-fusion call site in model code (RFC #43224) does not need to import
# vllm.compilation. Importing MLAAttention above triggers the registration.
